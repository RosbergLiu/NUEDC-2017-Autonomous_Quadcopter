...
void OLED_Init(void)        
{
  GPIO_InitTypeDef OLED_GPIO_InitStructure;
	...
	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOA | RCC_AHB1Periph_GPIOC, ENABLE); 	 //GPIO
  ...
  OLED_GPIO_InitStructure.GPIO_Pin = OLED_SCL|OLED_SDA;
	...
	OLED_GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL;
	GPIO_Init(GPIOA, &OLED_GPIO_InitStructure); 	

	OLED_GPIO_InitStructure.GPIO_Pin = OLED_DC;	
	GPIO_Init(GPIOC, &OLED_GPIO_InitStructure); 

	OLED_GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_DOWN;
	OLED_GPIO_InitStructure.GPIO_Pin = OLED_RST;
	GPIO_Init(GPIOC, &OLED_GPIO_InitStructure);
...
void OLED_S3num(unsigned char x,unsigned char y, int number)
{
    unsigned char qian,bai,shi,ge;
	int num =number;
	if(num<0)
...
{
//	OLED_P6x8Str(5,1,"Welcome");
	OLED_P6x8Str(0, 1,"Bat:");  OLED_P6x8Str(54,1,"High:");
    OLED_P6x8Str(0, 2,"ROL:");  OLED_P6x8Str(54,2,"PIT:");
    OLED_P6x8Str(0, 3,"YAW:");  OLED_P6x8Str(54,3,"TASK:");
    OLED_P6x8Str(0, 4,"DX:");   OLED_P6x8Str(54,4,"DY:");
    OLED_P6x8Str(0, 5,"AP:");   OLED_P6x8Str(54,5,"AD:");
    OLED_P6x8Str(0, 6,"PP:");   OLED_P6x8Str(54,6,"PD:");
//    OLED_P6x8Str(0, 7,"NC");    OLED_P6x8Str(54,7,"NC");
}
...
void Screen_Update(void)
{
    ...
    Dis_Float(1,24,Bat_volt,1);
    OLED_3num(14,1,desired_height);
    Dis_Float(2,24,Roll,1);
    Dis_Float(2,78,Pitch,1);
    Dis_Float(3,24,Yaw,1);
    OLED_3num(14,3,receive_task);
    OLED_S3num(3,4,circle.x);
    OLED_S3num(12,4,circle.y);
    Dis_Float(5,18,Height_Control._kp,2);
    Dis_Float(5,72,Height_Control._kd,2);
    Dis_Float(6,18,PID_PosHold_roll._kp,2);
    Dis_Float(6,72,PID_PosHold_roll._kd,2);
    OLED_3num(2,7,NS);
//	  Dis_Float(3,70,_ahrs.roll_sensor/100.0f,2);
//		OLED_3num(5,2,desired_height);
		//OLED_3num(5,3,TAKE_OFF_flag);
//		OLED_3num(4,4,fly_state.line_dx);
//		OLED_3num(5,5,fly_state.line_theta);
//	  OLED_3num(4,6,fly_state.circle_dx);
//	  OLED_3num(4,7,fly_state.circle_dy);
//	  OLED_3num(16,4,Switch.ch6);
//		Dis_Float(5,70,Target_roll_delt,2);
//		Dis_Float(6,70,Target_pitch_delt,2);
//  	//OLED_3num(16,7,enable_search);
//		OLED_4num(16,7,value_from_varA);
}
