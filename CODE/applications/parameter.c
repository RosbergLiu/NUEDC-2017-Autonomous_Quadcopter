...
static void  Param_SetSettingToFC(void) 
{
  ...
  memcpy(&ctrl_1.PID[PIDROLL],&pid_setup.groups.ctrl1.roll,sizeof(pid_t));
	...
	memcpy(&ctrl_PIDcustomized.PID[PIDROLL],&pid_setup.groups.ctrlPIDcustomized.roll,sizeof(pid_t));
	memcpy(&ctrl_PIDcustomized.PID[PIDPITCH],&pid_setup.groups.ctrlPIDcustomized.pitch,sizeof(pid_t));
	memcpy(&ctrl_PIDcustomized.PID[PIDYAW],&pid_setup.groups.ctrlPIDcustomized.yaw,sizeof(pid_t));
...
// 	sensor_setup.Offset.Gyro_Temperature = 0;
  ...
  pid_setup.groups.ctrl2.yaw.kd   = 0.1;
	...
	pid_setup.groups.ctrlPIDcustomized.pitch.kp = 0.72f;
	pid_setup.groups.ctrlPIDcustomized.roll.kp  = 0.72f;	
	pid_setup.groups.ctrlPIDcustomized.yaw.kp   = 2.8f;	
	
	pid_setup.groups.ctrlPIDcustomized.pitch.ki = 0;
	pid_setup.groups.ctrlPIDcustomized.roll.ki  = 0;	
	pid_setup.groups.ctrlPIDcustomized.yaw.ki   = 0;	
	
	
	pid_setup.groups.ctrlPIDcustomized.pitch.kd = 1.0f;
	pid_setup.groups.ctrlPIDcustomized.roll.kd  = 1.0f;	
	pid_setup.groups.ctrlPIDcustomized.yaw.kd   = 0.01f;	
...
void Param_SavePID(void)
{
 ...
 memcpy(&pid_setup.groups.ctrlPIDcustomized.roll,&ctrl_PIDcustomized.PID[PIDROLL],sizeof(pid_t));
 memcpy(&pid_setup.groups.ctrlPIDcustomized.pitch,&ctrl_PIDcustomized.PID[PIDPITCH],sizeof(pid_t));
 memcpy(&pid_setup.groups.ctrlPIDcustomized.yaw,&ctrl_PIDcustomized.PID[PIDYAW],sizeof(pid_t));
