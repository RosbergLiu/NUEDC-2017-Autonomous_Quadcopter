...
/////////////////////////////////////////////////////////////////////////////////////
	else if(f.send_senser2)
	{
        ...
        ANO_DT_Send_Senser2(ultra.height,ultra.relative_height);//原始数据
	}	
/////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_pid5 = 0;
		ANO_DT_Send_PID(5,ctrl_PIDcustomized.PID[PIDROLL].kp,ctrl_PIDcustomized.PID[PIDROLL].ki,ctrl_PIDcustomized.PID[PIDROLL].kd,
                        ctrl_PIDcustomized.PID[PIDPITCH].kp,ctrl_PIDcustomized.PID[PIDPITCH].ki,ctrl_PIDcustomized.PID[PIDPITCH].kd,
                        ctrl_PIDcustomized.PID[PIDYAW].kp,ctrl_PIDcustomized.PID[PIDYAW].ki,ctrl_PIDcustomized.PID[PIDYAW].kd);
	}
	else if(f.send_pid6)
	{
		f.send_pid6 = 0;
...
//         pid_setup.groups.ctrl3.kd 	= 0.001*( (vs16)(*(data_buf+20)<<8)|*(data_buf+21) );
	...
	{
        ctrl_PIDcustomized.PID[PIDROLL].kp  = 0.001*( (vs16)(*(data_buf+4)<<8)|*(data_buf+5) );
        ctrl_PIDcustomized.PID[PIDROLL].ki  = 0.001*( (vs16)(*(data_buf+6)<<8)|*(data_buf+7) );
        ctrl_PIDcustomized.PID[PIDROLL].kd  = 0.001*( (vs16)(*(data_buf+8)<<8)|*(data_buf+9) );
        ctrl_PIDcustomized.PID[PIDPITCH].kp = 0.001*( (vs16)(*(data_buf+10)<<8)|*(data_buf+11) );
        ctrl_PIDcustomized.PID[PIDPITCH].ki = 0.001*( (vs16)(*(data_buf+12)<<8)|*(data_buf+13) );
        ctrl_PIDcustomized.PID[PIDPITCH].kd = 0.001*( (vs16)(*(data_buf+14)<<8)|*(data_buf+15) );
        ctrl_PIDcustomized.PID[PIDYAW].kp 	= 0.001*( (vs16)(*(data_buf+16)<<8)|*(data_buf+17) );
        ctrl_PIDcustomized.PID[PIDYAW].ki 	= 0.001*( (vs16)(*(data_buf+18)<<8)|*(data_buf+19) );
        ctrl_PIDcustomized.PID[PIDYAW].kd 	= 0.001*( (vs16)(*(data_buf+20)<<8)|*(data_buf+21) );
		
		
			PID_PosHold_roll._kp = 0.1f*ctrl_PIDcustomized.PID[PIDROLL].kp;
			PID_PosHold_roll._ki = ctrl_PIDcustomized.PID[PIDROLL].ki;
			PID_PosHold_roll._kd = 100.0f*ctrl_PIDcustomized.PID[PIDROLL].kd;
	
			PID_PosHold_pitch._kp = 0.1f*ctrl_PIDcustomized.PID[PIDPITCH].kp;
			PID_PosHold_pitch._ki = ctrl_PIDcustomized.PID[PIDPITCH].ki;
			PID_PosHold_pitch._kd = 100.0f*ctrl_PIDcustomized.PID[PIDPITCH].kd;
	
			Height_Control._kp = 0.1f*ctrl_PIDcustomized.PID[PIDYAW].kp;
			Height_Control._ki = ctrl_PIDcustomized.PID[PIDYAW].ki;
			Height_Control._kd = 1.0f*ctrl_PIDcustomized.PID[PIDYAW].kd;
...
void ANO_DT_Send_User()
{
	...
	_temp = (s16)(poshold_roll_pid_output*100);
	data_to_send[_cnt++]=BYTE1(_temp);
	data_to_send[_cnt++]=BYTE0(_temp);
	
    _temp = (s16)(poshold_pitch_pid_output*100);              //5
	data_to_send[_cnt++]=BYTE1(_temp);
	data_to_send[_cnt++]=BYTE0(_temp);
	
	_temp = (s16)(data_updated*100);              //6
	data_to_send[_cnt++]=BYTE1(_temp);
	data_to_send[_cnt++]=BYTE0(_temp);

	_temp = (s16)(height_pid_output);              //7
	data_to_send[_cnt++]=BYTE1(_temp);
	data_to_send[_cnt++]=BYTE0(_temp);
